...
// A Point Set Shape Node Element defines a collection of independent and unconnected points.
// Each point constitutes one primitive of the set and is defined by one vertex coordinate
type PointSetShapeNode struct {
	VertexShapeNode
...
func (n PointSetShapeNode) GUID() model.GUID {
	return model.PointSetShapeNodeElement
}

func (n *PointSetShapeNode) Read(c *model.Context) error {
	c.LogGroup("PointSetShapeNode")
	defer c.LogGroupEnd()
...
func (n *PointSetShapeNode) GetBaseNode() *BaseNode {
	return &n.BaseNode
}

func (n *PointSetShapeNode) BaseElement() *JTElement {
	return &n.JTElement
}
